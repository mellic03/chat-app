...
export class GroupsettingsComponent implements OnInit {
  ...
  create_channel() {
    ...
    this.http.get(`/backend/api/groups/${this.group_name}/channels`);
  ...
  upload_image() {
    this.http.post<any>(`/backend/api/groups/${this.group.name}/update_photo/`, {
